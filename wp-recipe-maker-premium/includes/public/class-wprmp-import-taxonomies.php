...
class WPRMP_Import_Taxonomies {
	...
	public static function add_submenu_page() {
		add_submenu_page( null, __( 'WPRM Import from JSON', 'wp-recipe-maker' ), __( 'WPRM Import from JSON', 'wp-recipe-maker' ), WPRM_Settings::get( 'features_import_access' ), 'wprm_import_taxonomies', array( __CLASS__, 'import_taxonomies_page_template' ) );
	}
