...
class WPRMP_Import_Paprika {
	...
	public static function add_submenu_page() {
		add_submenu_page( null, __( 'WPRM Import from Paprika', 'wp-recipe-maker' ), __( 'WPRM Import from Paprika', 'wp-recipe-maker' ), WPRM_Settings::get( 'features_import_access' ), 'wprm_import_paprika', array( __CLASS__, 'import_paprika_page_template' ) );
	}
