...
class WPRMP_Nutrition_Label_Layout {
	...
	public static function add_submenu_page() {
		add_submenu_page( null, __( 'Nutrition Label Layout', 'wp-recipe-maker-premium' ), __( 'Nutrition Label Layout', 'wp-recipe-maker-premium' ), 'manage_options', 'wprmp_nutrition_label_layout', array( __CLASS__, 'layout_page_template' ) );
	}
