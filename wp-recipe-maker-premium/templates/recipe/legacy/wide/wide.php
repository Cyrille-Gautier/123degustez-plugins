<?php
/**
 * Wide recipe template.
 *
 * @link       http://bootstrapped.ventures
 * @since      1.0.0
 *
 * @package    WP_Recipe_Maker_Premium
 * @subpackage WP_Recipe_Maker_Premium/templates/recipe/legacy/wide
 */
...
?>
<div class="wprm-recipe wprm-recipe-wide">
	<div class="wprm-recipe-top">
		<div class="wprm-recipe-image-container">
			<div class="wprm-recipe-image"><?php echo WPRM_Template_Helper::recipe_image( $recipe, array( 300, 200 ) ); ?></div>
		</div>
