<?php
/**
 * Colorful recipe template.
 *
 * @link       http://bootstrapped.ventures
 * @since      1.0.0
 *
 * @package    WP_Recipe_Maker_Premium
 * @subpackage WP_Recipe_Maker_Premium/templates/recipe/legacy/colorful
 */
...
<div class="wprm-recipe wprm-recipe-colorful">
	<div class="wprm-recipe-top wprm-color-accent">
		...
		<div class="wprm-recipe-top-text-container">
			...
			<div class="wprm-recipe-buttons">
				<a href="<?php echo $recipe->print_url(); ?>" class="wprm-recipe-print" target="_blank" rel="nofollow"><?php echo WPRM_Template_Helper::label( 'print_button' ); ?></a>
			</div>
		</div>
	</div>
	<div class="wprm-recipe-meta">
		...
		<div class="wprm-recipe-meta-container wprm-color-accent2 wprm-recipe-prep-time-container">
		...
		<div class="wprm-recipe-meta-container wprm-color-accent2 wprm-recipe-cook-time-container">
		...
		<div class="wprm-recipe-meta-container wprm-color-accent2 wprm-recipe-custom-time-container">
		...
		<div class="wprm-recipe-meta-container wprm-color-accent2 wprm-recipe-servings-container">
		...
		<div class="wprm-recipe-meta-container wprm-color-accent2 wprm-recipe-calories-container">
		...
		<div class="wprm-recipe-meta-container wprm-color-accent2 wprm-recipe-author-container">
	...
	<div class="wprm-recipe-main">
		...
		<h3 class="wprm-recipe-header wprm-color-accent"><?php echo WPRM_Template_Helper::label( 'ingredients' ); ?></h3>
		...
		<h3 class="wprm-recipe-header wprm-color-accent"><?php echo WPRM_Template_Helper::label( 'instructions' ); ?></h3>
			...
			<div class="wprm-recipe-instruction-group">
				...
				<ol class="wprm-recipe-instructions">
					...
					<li class="wprm-recipe-instruction">
						...
						<div class="wprm-recipe-instruction-media wprm-recipe-instruction-image"><?php echo WPRM_Template_Helper::instruction_image( $instruction, 'thumbnail' ); ?></div>
	...
	<?php if ( $recipe->video() ) : ?>
	<h3 class="wprm-recipe-header wprm-color-accent"><?php echo WPRM_Template_Helper::label( 'video' ); ?></h3>
	<div id="wprm-recipe-video-container-<?php echo $recipe->id(); ?>" class="wprm-recipe-video-container">
		<?php echo $recipe->video(); ?>
	</div>
	<?php endif; // Video. ?>
	<?php if ( $recipe->notes() ) : ?>
	<h3 class="wprm-recipe-header wprm-color-accent"><?php echo WPRM_Template_Helper::label( 'notes' ); ?></h3>
