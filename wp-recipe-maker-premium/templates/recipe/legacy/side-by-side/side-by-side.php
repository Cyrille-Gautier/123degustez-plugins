<?php
/**
 * Side by Side recipe template.
 *
 * @link       http://bootstrapped.ventures
 * @since      1.0.0
 *
 * @package    WP_Recipe_Maker_Premium
 * @subpackage WP_Recipe_Maker_Premium/templates/recipe/legacy/side-by-side
 */
...
?>
<div class="wprm-recipe wprm-recipe-side-by-side">
	...
	<?php if ( $recipe->video() ) : ?>
	<div id="wprm-recipe-video-container-<?php echo $recipe->id(); ?>" class="wprm-recipe-video-container wprm-color-border">
